            ...
            <View style={styles.container}>
                <View style={styles.movimentacaoContainer}>
                    <View style={styles.movimentacaoInfoContainerTitle}>
                        <Text style={styles.movimentacaoInfoTitle}>{this.props.objeto.nome}</Text>
                    </View>

                    <View style={styles.movimentacaoInfoContainer}>
                        <View style={styles.valorInfoContainer}>
                            <Text style={styles.valorInfoTitle}>Categoria: </Text>
                            <Text style={styles.movimentacaoInfo}>{this.props.objeto.categoria}</Text>
                        </View>

                        <View style={styles.valorInfoContainer}>
                            <Text style={styles.valorInfoTitle}>Periodicidade: </Text>
                            <Text style={styles.movimentacaoInfo}>{this.props.objeto.periodicidade}</Text>
                        </View>
                    </View>
                </View>
            </View>
