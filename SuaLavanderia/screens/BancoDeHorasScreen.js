...
export default class BancoDeHorasScreen extends React.Component {
    ...
    navegarParaDetalhes = (oid) => {
        this.setState({oid})
        this.props.navigation.navigate("BancoDeHorasDetails", { oid: this.state.oid})
    };
            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.objetoList}>
                    {this.state.objetos.map(objeto => 
                        <TouchableOpacity key={objeto.oid} onPress={() => this.navegarParaDetalhes(objeto.oid)}>
