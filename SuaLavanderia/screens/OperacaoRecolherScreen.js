...
export default class OperacaoRecolherScreen extends React.Component {
    ...
    buscar = async () => {
        ...
        var argumentos = `status=1;2&dataInicial=${dataInicialParameter}&dataFinal=${dataFinalParameter}&usarDataPreferivelParaEntrega=true&recolhidaDoVaral=false&operacoes=true&soPassar=false&incluirRoupas=false`;
    ...
    navegarParaDetalhes = () => {
        this.setState({confirmacaoModalVisible: false});
        this.props.navigation.navigate("LavagemDetailsOperacaoRecolher", { lavagem: this.state.lavagem, acao: this.acao, texto: "Confirmar recolher tudo?", usuarioOid: this.props.route.params.usuarioOid })
    };
    ...
    openVideoInformativo = () => {
        Linking.openURL("http://sualavanderia.com.br/videos/OperacaoRecolherScreen.mp4");
    };
    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                <ConfirmacaoModalComDetalhes visible={this.state.confirmacaoModalVisible} texto="Confirmar recolher tudo?" 
