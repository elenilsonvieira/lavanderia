...
export default class LavagemDetailsPapelOperacoes extends React.Component {
    ...
    openVideoInformativo = () => {
        Linking.openURL("http://sualavanderia.com.br/videos/LavagemDetailsPapelOperacoes.mp4");
    };
