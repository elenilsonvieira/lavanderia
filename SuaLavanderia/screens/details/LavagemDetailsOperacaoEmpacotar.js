...
import {TouchableOpacity, Image, StyleSheet, View, ScrollView, Text, Linking, TextInput } from 'react-native';
...
export default class LavagemDetailsOperacaoEmpacotar extends React.Component {
    ...
    navegarParaOperacaoListaDeEntregaDireta = () => {
        this.props.navigation.navigate('OperacaoListaDeEntregaDireta', {lavagemOid: this.state.lavagem.oid, unidadeOid: this.state.lavagem.unidadeDeRecebimentoOid, usuarioOid: this.props.route.params.usuarioOid});
    };
