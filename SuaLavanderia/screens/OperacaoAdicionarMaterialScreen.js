...
export default class OperacaoAdicionarMaterialScreen extends React.Component {
    ...
    acao = async (quantidade) => {
        ...
        var argumentos = `materialOid=${this.state.materialOid}&usuarioOid=${usuarioOid}&quantidade=${this.state.quantidade}&modo=entrada`;
    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                texto="Adicionar quantos?" onSim={this.acao} onNao={this.closeModal} definirQuantidade={this.definirQuantidade} />
            </View>
        );
    }
