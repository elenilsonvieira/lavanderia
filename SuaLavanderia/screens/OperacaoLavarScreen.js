...
export default class OperacaoLavarScreen extends React.Component {
    ...
    buscar = async () => {
        ...
        var argumentos = `status=0&dataInicial=${dataInicialParameter}&dataFinal=${dataFinalParameter}&operacoes=true&soPassar=false&&usarDataPreferivelParaEntrega=true&incluirRoupas=false`;
