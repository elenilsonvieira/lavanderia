...
export default class OperacaoPassadorExtraScreen extends React.Component {
    ...
    navegarParaDetalhes = () => {
        this.setState({confirmacaoModalVisible: false});
        this.props.navigation.navigate("LavagemDetailsOperacoes", { lavagem: this.state.lavagem, acao: this.acao, texto: "Confirmar Passador Extra?" })
    };
    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                <ConfirmacaoModalComDetalhes visible={this.state.confirmacaoModalVisible} texto="Confirmar passador extra?" 
